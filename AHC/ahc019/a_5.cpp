...
void solve() {
    ...
    int num_pair_block = min(num_pair_1, num_pair_2);
    for (int i = 0; i < (int)pair_no_1.size(); i++) {
        if (pair_no_1[i] > num_pair_block) {
            pair_no_1[i] = 0;
        }
    }
    for (int i = 0; i < (int)pair_no_2.size(); i++) {
        if (pair_no_2[i] > num_pair_block) {
            pair_no_2[i] = 0;
        }
    }
